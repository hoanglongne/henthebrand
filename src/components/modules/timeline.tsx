...
import { statusLabels } from "@/lib/domain/types";
export function Timeline() {
  ...
  function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (end < start) {
      setError("Tuần kết thúc phải bằng hoặc sau tuần bắt đầu.");
      return;
    }
    setData((d) => ({
      ...d,
    ...
    record(`Điều chỉnh mốc ${selected.name}`);
    setSelected(null);
  }
  return (
    <>
      ...
      >
        {selected && (
          <form className="form-stack" onSubmit={submit}>
            ...
            <p className="notice">
              Dời milestone có thể ảnh hưởng kế hoạch launch. Ngày của task và
              campaign sẽ không tự đổi; cần rà soát các việc liên quan.
            </p>
            {error && (
            ...
            <FormFooter onClose={() => setSelected(null)} />
          </form>
        )}
      </Modal>
    </>
